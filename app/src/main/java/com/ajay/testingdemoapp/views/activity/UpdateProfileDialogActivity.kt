...
import com.ajay.testingdemoapp.databinding.ActivityUpdateProfileDialogBinding
...
import com.ajay.testingdemoapp.viewModelFactory.UpdateProfileViewModelFactory
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == 104) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(
                    this,
                    "Storage Permission is required to use Gallery",
                    Toast.LENGTH_SHORT
                ).show()
        }
    }
